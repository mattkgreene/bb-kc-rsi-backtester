    ...
    *,
    ...
    for fold_idx, (train_start, train_end, test_start, test_end) in enumerate(splits, start=1):
        ...
        test_stats, _, _, _ = run_backtest(
            ...
            rsi_max=test_params.get("rsi_max"),
            rsi_ma_max=test_params.get("rsi_ma_max"),
            ...
            trade_direction=test_params.get("trade_direction", "Short"),
...
def create_custom_grid(
    ...
    Args:
        ...
        stop_range: (min, max) for stop loss percentage or ATR multiplier
        ...
        stop_mode: If "ATR", stop_range is interpreted as ATR multipliers.
